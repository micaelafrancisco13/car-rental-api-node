...
(
    ...
    "deliveryType"  "DeliveryType"  NOT NULL DEFAULT 'DROPOFF',
    "createdAt"     TIMESTAMP(3)    NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt"     TIMESTAMP(3)    NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Booking"
    ADD CONSTRAINT "Booking_bookerId_fkey" FOREIGN KEY ("bookerId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
